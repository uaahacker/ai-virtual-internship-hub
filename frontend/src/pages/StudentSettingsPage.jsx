          ...
          <div className="bg-white rounded-xl shadow-sm p-8 space-y-6">
            ...
            <div>
              ...
              <div className="flex items-center gap-6">
                ...
                <div className="w-24 h-24 bg-gradient-to-br from-blue-500 to-blue-600 rounded-full flex items-center justify-center font-bold text-white text-3xl flex-shrink-0">
                  {profileForm.preview ? (
                    <img
